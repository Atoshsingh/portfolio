  ...
  return (
    <div className=' md:top-[64px] w-full md:h-[calc(100vh-64px)] top-0 h-screen'>
      ...
      <p className='text-[#77d6ff] text-2xl md:text-4xl hover:scale-110 duration-500 font-extrabold'>RESUME</p>
        <div className='h-[600px] md:h-[1300px]  flex flex-row justify-center items-center'>
          <img className='xl:w-[860px] hover:scale-95 xl:h-[1200px] md:w-[640px] md:h-[1010px] w-[300px] h-[450px] transition-all ease-in-out duration-700 rounded-2xl' src={AashutoshJpg} alt='my remsume pic' />
        </div>
